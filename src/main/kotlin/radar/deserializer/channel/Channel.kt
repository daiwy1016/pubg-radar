...
import radar.deserializer.RELIABLE_BUFFER
import radar.gameStarted
import radar.register
import radar.struct.Bunch
import radar.struct.NetGUIDCache.Companion.guidCache
...
//          print("Received New partial bunch. It only contained NetGUIDs")
    ...
    if (HandleBunch != null)
    {
      ...
      // In the case of a partial, HandleBunch should == InPartialBunch, and radar.struct.Bunch should be the last bunch.
